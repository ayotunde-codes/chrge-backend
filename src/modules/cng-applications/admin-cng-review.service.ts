  ...
  async detail(
    ...
    const app = await this.prisma.cngApplication.findUnique({
      ...
      include: {
        ...
        additionalInformationRequests: {
          include: {
            responses: { include: { documents: true }, orderBy: { submittedAt: 'desc' } },
          },
    ...
    return {
      ...
      applicant: {
        ...
        employmentSector: app.employmentSector,
        employerName: app.employerName,
        occupationJobTitle: app.occupationJobTitle,
        monthlyIncome: app.monthlyIncome,
        employmentStartDate: app.employmentStartDate,
        employmentConfirmationDate: app.employmentConfirmationDate,
        address: app.address,
        lga: app.lga,
      ...
      vehicle: {
        ...
        manufacturingDate: app.manufacturingDate,
        color: app.vehicleColor,
        mileage: app.mileage,
        fuelSystem: app.fuelSystem,
        engineType: app.engineType,
      },
      financing: {
        packageId: app.packageId,
        packageName: app.packageNameSnapshot,
        packageTank: app.packageTankSnapshot,
        financingPlanId: app.financingPlanId,
        financingPlanName: app.financingPlanNameSnapshot,
        configurationVersionId: app.financingConfigVersionId,
        depositPct: app.depositPctSnapshot,
        interestRateBps: app.interestRateBpsSnapshot,
      ...
      documents: app.documents.map((d) => ({
        ...
        versions: app.documentVersions
          .filter((version) => version.documentId === d.id)
          .map((version) => ({
            id: version.id,
      ...
      additionalInformation: app.additionalInformationRequests.map((request) => ({
        id: request.id,
